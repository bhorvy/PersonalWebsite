  ...
  return (
    <div style={{ width: '100%', height: '100%', position: 'relative' }}>
      ...
      <div  className="d-flex flex-column my-2 justify-content-center align-items-center" style={{zIndex: 1}}>
        ...
        <div className="col-lg-2 d-flex flex-column justify-content-center div-style-3 my-2 text-center" style={{ minHeight: '30vh', minWidth: '70vh' }}>
        ...
        <div className="col-lg-2 d-flex flex-column justify-content-center text-center div-style-3 my-2 px-2" style={{ minHeight: '30vh', minWidth: '70vh' }}>
