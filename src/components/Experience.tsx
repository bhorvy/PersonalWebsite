  ...
  return (
    <div style={{ width: '100%', height: '100%', position: 'relative' }}>
      ...
      <div  className="d-flex flex-column my-2 justify-content-center align-items-center" style={{zIndex: 1}}>
        ...
        <div className="col-lg-2 d-flex flex-column justify-content-center text-center div-style-3 my-2" style={{ minHeight: '30vh', minWidth: '50vh' }}>
          <h4 data-usal="text-fluid split-letter duration-1750 split-delay-75">Currently:</h4>
          <p>Building a Blackjack game with a Balatro Twist in C++, implementing Lua asap.</p>
        </div>
        <div className="col-lg-2 d-flex flex-column justify-content-center text-center div-style-3 my-2 px-2" style={{ minHeight: '30vh', minWidth: '50vh' }}>
