 ...
 *
 * The ASCII generation is based on [mrdoob](https://github.com/mrdoob/three.js/blob/master/examples/jsm/effects/AsciiEffect.js).
 * Converting it to TypeScript and adding some features.
 *
...
class AsciiEffect {
	...
	constructor( renderer : WebGLRenderer, charSet = ' .:-=+*#%@', options = {} as AsciiEffectOptions ) {
		 ...
		 */
		this.setSize = function ( w : number, h : number ) {
